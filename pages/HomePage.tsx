...
const HomePage: React.FC = () => {
  ...
  return (
    <main>
      ...
      <section className="relative h-[90vh] w-full overflow-hidden bg-stone-900 -mt-[112px]">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-4 pt-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link to="/shop" className="bg-primary text-white px-8 py-4 text-xs tracking-widest uppercase font-bold hover:bg-opacity-90 transition-all rounded-sm text-center">Shop The Reserve</Link>
            <button className="border border-white text-white px-8 py-4 text-xs tracking-widest uppercase font-bold hover:bg-white hover:text-stone-900 transition-all rounded-sm">Discover Heritage</button>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[700px]">
          ...
          <div className="md:col-span-7 relative group overflow-hidden rounded-lg bg-stone-200">
            ...
            <div className="absolute bottom-8 left-8 text-white">
              ...
              <Link to="/shop" className="text-[10px] tracking-widest uppercase font-bold border-b border-white pb-1 group-hover:text-accent-gold group-hover:border-accent-gold transition-all">Explore Series</Link>
            </div>
          </div>
          ...
          <div className="md:col-span-5 flex flex-col gap-6">
            <div className="h-1/2 relative group overflow-hidden rounded-lg bg-stone-200">
              ...
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <Link to="/shop" className="text-[9px] tracking-widest uppercase font-bold opacity-80 hover:opacity-100 hover:text-accent-gold transition-all">Shop Roast</Link>
              </div>
            </div>
            <div className="h-1/2 relative group overflow-hidden rounded-lg bg-stone-200">
              <div 
              ...
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <Link to="/shop" className="text-[9px] tracking-widest uppercase font-bold opacity-80 hover:opacity-100 hover:text-accent-gold transition-all">Export Inquiry</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Legacy Section */}
      <section className="py-24 grid md:grid-cols-2 gap-0 overflow-hidden">
      ...
      <section className="bg-[#213e2b] dark:bg-[#0a0f0a] py-20 border-y border-stone-800/20">
        <div className="px-6 md:px-12 max-w-[1200px] mx-auto text-center">
          ...
          <form className="flex flex-col md:flex-row gap-0 max-w-md mx-auto overflow-hidden rounded shadow-2xl">
            ...
            <button className="bg-accent-gold text-white px-8 py-4 text-xs tracking-widest uppercase font-bold hover:bg-white hover:text-primary transition-all">Subscribe</button>
          </form>
        </div>
      </section>
    </main>
